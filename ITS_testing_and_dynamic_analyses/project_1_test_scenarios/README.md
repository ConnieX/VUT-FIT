...
<!-- ngIf: profile.enableWordsCount && !viewSrcMode --><p ng-if="profile.enableWordsCount &amp;&amp; !viewSrcMode" class="words ng-scope">Words: <span class="counter ng-binding" ng-bind="words">153</span></p><!-- end ngIf: profile.enableWordsCount && !viewSrcMode -->
<!-- ngIf: profile.enableCharactersCount && !viewSrcMode --><p ng-if="profile.enableCharactersCount &amp;&amp; !viewSrcMode" class="characters ng-scope">Characters: <span class="counter ng-binding" ng-bind="characters">1107</span></p><!-- end ngIf: profile.enableCharactersCount && !viewSrcMode -->
</div>
<div class="g mnone">
...
<div id="editor" class="ui-resizable-e ace_editor ace-dillinger ace_focus" style="height: 1400px;"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; left: 843px; top: 336px; height: 28px; width: 7px;"></textarea><div class="ace_gutter" aria-hidden="true"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="margin-top: 0px; height: 1484px; width: 40px;"><div class="ace_gutter-cell " style="height: 28px;">1</div><div class="ace_gutter-cell " style="height: 28px;">2</div><div class="ace_gutter-cell " style="height: 28px;">3</div><div class="ace_gutter-cell " style="height: 56px;">4</div><div class="ace_gutter-cell " style="height: 28px;">5</div><div class="ace_gutter-cell " style="height: 112px;">6</div><div class="ace_gutter-cell " style="height: 56px;">7</div><div class="ace_gutter-cell " style="height: 56px;">8</div></div><div class="ace_gutter-active-line" style="top: 336px; height: 56px;"></div></div><div class="ace_scroller" style="left: 41px; right: 0px; bottom: 0px;"><div class="ace_content" style="margin-top: 0px; width: 859px; height: 1484px; margin-left: 0px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 564px; visibility: hidden;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height:28px;top:336px;left:0;right:0;"></div></div><div class="ace_layer ace_text-layer" style="padding: 0px 4px;"><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">ITS projekt 1</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Vypracování BDD scénářů pro internetový obchod OpenCart</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Autor: Monika Rosinská, xrosin00</span></div></div><div class="ace_line_group" style="height:56px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Návrh testovacích scénářů je zaměřen na uživatelské akce - konkrétně pohyb po webové stránce obchodu OpenCart, účty a </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">akce s nimi spojené a samotné nakupovaní v OpenCart.</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"></div></div><div class="ace_line_group" style="height:112px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Pohyb po webové stránce (movement-on-the-page.feature) obsahuje scénáře pro běžné operace, které uživatel provádí. Patří </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">sem zobrazení celé kategorie produktů či samotného produktu, jednoduché navrácení na domovskou stránku,přidání a odebrání </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">produktu z seznamu pro porovnání produktů, přidání a odebrání produktu z "wish listu" a změna měny, ve které se zobrazuje </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">cena produktu.</span></div></div><div class="ace_line_group" style="height:56px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Účty a akce s nimi spojené (account-actions.feature) obsahuje scénáře pro vytvoření nového účtu, přihlášení a odhlášení z </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">účtu a změnu informací o účtu. Dále obsahuje scénář pro změnu hesla, změnu a přidání adresy nebo odběr newsletteru.</span></div></div><div class="ace_line_group" style="height: 56px;"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Nakupování (cart-and-shopping-actions.feature) obsahuje scénáře pro přidání produktu do košíku, zobrazení košíku, úpravu </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">produktů a počtu kusů produktu v košíku, zaplacení objednávky a vrácení objednaného předmětu.</span></div></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer"><div class="ace_cursor" style="left: 802px; top: 336px; width: 7px; height: 28px;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="display: none; width: 20px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 20px; height: 392px;"></div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 20px; left: 41px; right: 0px;"><div class="ace_scrollbar-inner" style="height: 20px; width: 859px;"></div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;"></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;">XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</div></div></div>
</div>
<div id="preview1" class="g-b g-b--t1of2 split split-preview" style="height: 760px;">
<div id="preview" class="preview-html" preview="" debounce="150"><p class="has-line-data" data-line-start="0" data-line-end="4">ITS projekt 1<br>
Vypracování BDD scénářů pro internetový obchod OpenCart<br>
Autor: Monika Rosinská, xrosin00<br>
Návrh testovacích scénářů je zaměřen na uživatelské akce - konkrétně pohyb po webové stránce obchodu OpenCart, účty a akce s nimi spojené a samotné nakupovaní v OpenCart.</p>
<p class="has-line-data" data-line-start="5" data-line-end="8">Pohyb po webové stránce (movement-on-the-page.feature) obsahuje scénáře pro běžné operace, které uživatel provádí. Patří sem zobrazení celé kategorie produktů či samotného produktu, jednoduché navrácení na domovskou stránku,přidání a odebrání produktu z seznamu pro porovnání produktů, přidání a odebrání produktu z “wish listu” a změna měny, ve které se zobrazuje cena produktu.<br>
Účty a akce s nimi spojené (account-actions.feature) obsahuje scénáře pro vytvoření nového účtu, přihlášení a odhlášení z účtu a změnu informací o účtu. Dále obsahuje scénář pro změnu hesla, změnu a přidání adresy nebo odběr newsletteru.<br>
Nakupování (cart-and-shopping-actions.feature) obsahuje scénáře pro přidání produktu do košíku, zobrazení košíku, úpravu produktů a počtu kusů produktu v košíku, zaplacení objednávky a vrácení objednaného předmětu.</p>
</div>
</div>
</div>
</div>
