...
<a ng-click="selectDocument(document)" class="ng-binding">IPK projekt 1 - HTTP resolver doménových jmen.md</a>
...
<!-- ngIf: profile.enableWordsCount && !viewSrcMode --><p ng-if="profile.enableWordsCount &amp;&amp; !viewSrcMode" class="words ng-scope">Words: <span class="counter ng-binding" ng-bind="words">650</span></p><!-- end ngIf: profile.enableWordsCount && !viewSrcMode -->
<!-- ngIf: profile.enableCharactersCount && !viewSrcMode --><p ng-if="profile.enableCharactersCount &amp;&amp; !viewSrcMode" class="characters ng-scope">Characters: <span class="counter ng-binding" ng-bind="characters">4466</span></p><!-- end ngIf: profile.enableCharactersCount && !viewSrcMode -->
</div>
<div class="g mnone">
...
<div id="editor1" class="g-b g-b--t1of2 split split-editor" style="height: 760px;">
<div id="editor" class="ui-resizable-e ace_editor ace-dillinger ace_focus" style="height: 1400px;"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; left: 661px; top: 1344px; height: 28px; width: 7px;"></textarea><div class="ace_gutter" aria-hidden="true"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="margin-top: 0px; height: 1456px; width: 47px;"><div class="ace_gutter-cell " style="height: 28px;">1<span class="ace_fold-widget ace_start ace_open" style="height: 28px;"></span></div><div class="ace_gutter-cell " style="height: 28px;">2<span class="ace_fold-widget ace_start ace_open" style="height: 28px;"></span></div><div class="ace_gutter-cell " style="height: 28px;">3<span class="ace_fold-widget ace_start ace_open" style="height: 28px;"></span></div><div class="ace_gutter-cell " style="height: 56px;">4</div><div class="ace_gutter-cell " style="height: 56px;">5</div><div class="ace_gutter-cell " style="height: 84px;">6</div><div class="ace_gutter-cell " style="height: 168px;">7</div><div class="ace_gutter-cell " style="height: 112px;">8</div><div class="ace_gutter-cell " style="height: 84px;">9</div><div class="ace_gutter-cell " style="height: 84px;">10</div><div class="ace_gutter-cell " style="height: 28px;">11</div><div class="ace_gutter-cell " style="height: 28px;">12</div><div class="ace_gutter-cell " style="height: 28px;">13<span class="ace_fold-widget ace_start ace_open" style="height: 28px;"></span></div><div class="ace_gutter-cell " style="height: 56px;">14</div><div class="ace_gutter-cell " style="height: 28px;">15</div><div class="ace_gutter-cell " style="height: 56px;">16</div><div class="ace_gutter-cell " style="height: 252px;">17</div><div class="ace_gutter-cell " style="height: 112px;">18</div><div class="ace_gutter-cell " style="height: 28px;">19</div><div class="ace_gutter-cell " style="height: 28px;">20</div></div><div class="ace_gutter-active-line" style="top: 1344px; height: 28px;"></div></div><div class="ace_scroller" style="left: 48px; right: 0px; bottom: 0px;"><div class="ace_content" style="margin-top: 0px; width: 852px; height: 1456px; margin-left: 0px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 564px; visibility: hidden;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height:28px;top:1344px;left:0;right:0;"></div></div><div class="ace_layer ace_text-layer" style="padding: 0px 4px;"><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_markup ace_heading ace_1">#</span><span class="ace_heading"> IPP projekt 2 - interpret a testovací skript pro programovací jazyk IPPcode2020</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_markup ace_heading ace_4">####</span><span class="ace_heading"> Autor: Monika Rosinská, xrosin00</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_markup ace_heading ace_2">##</span><span class="ace_heading"> Řešení interpretu:</span></div></div><div class="ace_line_group" style="height:56px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Aplikace nejdříve zpracuje argumenty zadané při spuštění programu - argument pro vypsání nápovědy ("--help") a argumenty </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">pro zdrojové soubory. Aplikace se ukončí s návratovým kódem 11 v případě, že je zadán neplatný soubor.</span></div></div><div class="ace_line_group" style="height:56px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Následně se aplikace pokusí převést vstup na strom, a zkontroluje argumenty instrukce a rootu. Poté zkontroluje a upraví </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">pořadí instrukcí v programu.</span></div></div><div class="ace_line_group" style="height:84px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Poté proběhne kontrola samotného XML. Zkontroluje se programovací jazyk, uvedené operační kódy pro instrukce jsou </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">zkontrolovány pomocí dictionary s povolenými instrukcemi a jejich argumenty. Po ověření počtu a uvedeného typu argumentů </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">je u každého argumentu pomocí regulárních výrazů provedena typová kontrola.</span></div></div><div class="ace_line_group" style="height:168px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Následně je vytvořena paměťová struktura programu pomocí třídy - global frame (dále GF) a temporary frame (dále TF) jsou </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">realizovány pomocí collection, která je tvořena jménem a hodnotou proměnné. Local frame (dále LF) je realizován pomocí </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">listu ve funkci stacku, kam se pushují jednotlivé struktury TF. Třída obsahuje i data-stack pro ukládání dočasných </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">hodnot a get-stac pro ukládání historie volání (kam se po vykonání funkce v kódu vrátit). V této třídě jsou také </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">implementovány funkce add - pro přidání nové proměnné, get - pro získání hodnoty proměnné, set - pro nastavení hodnoty </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">proměnné a get-type pro získání typu proměnné.</span></div></div><div class="ace_line_group" style="height:112px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Následně je vytvořeno pole pro uložení instrukcí - pořadí a název instrukce. Pomocí tohoto pole probíhá průchod celým </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">programem - slouží pro zjištění, která instrukce se má provádět. Nadále je ale využíván samotný strom. Případné </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">"přetečení" přes počet intrukcí kontroluje counter. Každý operační kód má svou vlastní funkci. Volání této funkce opět </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">funguje na slovníku.</span></div></div><div class="ace_line_group" style="height:84px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Z praktického důvodu jsou součástí programu i další funkce - get-frame pro zjištění, v jakém rámci se proměnná nachází; </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">get-by-frame pro získání hodnoty z proměnné (na základě rámce); is-type-int pro ověření, že hodnota je typu int; </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">return-type, který vrátí typ hodnoty v proměnné a change-string, která převede escape sekvence na string.</span></div></div><div class="ace_line_group" style="height:84px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Ve funkcích pro instrukce je dle potřeby zjištěn typ a hodnota argumentu, pokud se jedná o proměnnou, jsou tyto </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">informace zjištěny pomocí výše popsaných funkcí, je provedena daná instrukce, a každá funkce vrací číslo následující </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">instrukce.</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Při případných chybových stavech program končí s odpovídajícím návratovým kódem.</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_markup ace_heading ace_2">##</span><span class="ace_heading"> Řešení testovacího skriptu:</span></div></div><div class="ace_line_group" style="height:56px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Program zkontroluje argumenty zadané při spuštění programu - a uloží si tyto hodnoty (např. zdrojový kód interpretu, </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">informace o testování jen parseru, ...). </span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Následně proběhne vygenerování začátku html, a poté je podle parametrů spuštěn samotný program.</span></div></div><div class="ace_line_group" style="height:56px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Je otevřena složka a jsou z ní pomocí funkce open-dir načteny všechny elementy. Z těchto elementů jsou vybrány pouze </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">zdrojové soubory (funkce src-files).</span></div></div><div class="ace_line_group" style="height: 252px;"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Tyto soubory jsou jeden po druhém procházeny (ukládá se jejich počet). Pokud se jedná jen o interpret-only, proběhne </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">pokus o otevření </span><span class="ace_string ace_emphasis">_.in_</span><span class="ace_text ace_xml"> souboru - pokud neexistuje, vytvoří se prázdný soubor (následně je smazán). Následně je podle </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">parametrů spuštěn interpret nebo parser nad vstupním souborem, a pomocí funkce check-return-val je zkontrolována </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">návratová hodnota. Pokud soubor s návratovou hodnotou chybí, je návratová hodnota porovnávana s hodnotou 0. Pokud </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">hodnota odpovídá očekávané hodnotě, je v případě nenulového návratového kódu zvýšen počet úspěšných testů a začíná </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">kontrola dalšího souboru. Pokud hodnota neodpovídá, je vypsána příslušná hláška (do html), a pokračuje se kontrolou </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">dalšího souboru. Pokud je návratový kód shodný s očekávaným, a je roven 0, je buď zkontrolován výstup (pokud se jedná o </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">int-only či parse-only), nebo je výstup parseru předat interpretu. Interpret provede výše popsané v tomto odstavci, a </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">následuje kontrola kódu.</span></div></div><div class="ace_line_group" style="height: 112px;"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Kontrola kódu probíhá pomocí diff v případě výstupu z interpretu, a  pomocí speciálního nástroje v případě výstupu </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">parseru. Pokud soubor s výstupem chybí, je vygenerován prázdný, který se následně odstraní. Pokud je výstup shodný, je </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">navýšen počet úspěšných testů, a v případě úspěchu i neúspěchu je vypsána příslušná hláška (do html). Následuje kontrola </span></div><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">následujícího souboru.</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Vnořené prohledávání adresářů (argument --recursive) je provedeno pomocí rekursivního volání hlavní funkce.</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Následně je dogenerováno html, je vypsán počet úspěšných testů z celkového počtu testů a úspěšnost v procentech.</span></div></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer"><div class="ace_cursor" style="left: 613px; top: 1344px; width: 7px; height: 28px;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="display: none; width: 20px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 20px; height: 1372px;"></div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 20px; left: 48px; right: 0px;"><div class="ace_scrollbar-inner" style="height: 20px; width: 859px;"></div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;"></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;">XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</div></div></div>
</div>
<div id="preview1" class="g-b g-b--t1of2 split split-preview" style="height: 760px;">
<div id="preview" class="preview-html" preview="" debounce="150"><h1 class="code-line" data-line-start="0" data-line-end="1"><a id="IPP_projekt_2__interpret_a_testovac_skript_pro_programovac_jazyk_IPPcode2020_0"></a>IPP projekt 2 - interpret a testovací skript pro programovací jazyk IPPcode2020</h1>
<h4 class="code-line" data-line-start="1" data-line-end="2"><a id="Autor_Monika_Rosinsk_xrosin00_1"></a>Autor: Monika Rosinská, xrosin00</h4>
<h2 class="code-line" data-line-start="2" data-line-end="3"><a id="een_interpretu_2"></a>Řešení interpretu:</h2>
<p class="has-line-data" data-line-start="3" data-line-end="11">Aplikace nejdříve zpracuje argumenty zadané při spuštění programu - argument pro vypsání nápovědy ("–help") a argumenty pro zdrojové soubory. Aplikace se ukončí s návratovým kódem 11 v případě, že je zadán neplatný soubor.<br>
Následně se aplikace pokusí převést vstup na strom, a zkontroluje argumenty instrukce a rootu. Poté zkontroluje a upraví pořadí instrukcí v programu.<br>
Poté proběhne kontrola samotného XML. Zkontroluje se programovací jazyk, uvedené operační kódy pro instrukce jsou zkontrolovány pomocí dictionary s povolenými instrukcemi a jejich argumenty. Po ověření počtu a uvedeného typu argumentů je u každého argumentu pomocí regulárních výrazů provedena typová kontrola.<br>
Následně je vytvořena paměťová struktura programu pomocí třídy - global frame (dále GF) a temporary frame (dále TF) jsou realizovány pomocí collection, která je tvořena jménem a hodnotou proměnné. Local frame (dále LF) je realizován pomocí listu ve funkci stacku, kam se pushují jednotlivé struktury TF. Třída obsahuje i data-stack pro ukládání dočasných hodnot a get-stac pro ukládání historie volání (kam se po vykonání funkce v kódu vrátit). V této třídě jsou také implementovány funkce add - pro přidání nové proměnné, get - pro získání hodnoty proměnné, set - pro nastavení hodnoty proměnné a get-type pro získání typu proměnné.<br>
Následně je vytvořeno pole pro uložení instrukcí - pořadí a název instrukce. Pomocí tohoto pole probíhá průchod celým programem - slouží pro zjištění, která instrukce se má provádět. Nadále je ale využíván samotný strom. Případné “přetečení” přes počet intrukcí kontroluje counter. Každý operační kód má svou vlastní funkci. Volání této funkce opět funguje na slovníku.<br>
Z praktického důvodu jsou součástí programu i další funkce - get-frame pro zjištění, v jakém rámci se proměnná nachází; get-by-frame pro získání hodnoty z proměnné (na základě rámce); is-type-int pro ověření, že hodnota je typu int; return-type, který vrátí typ hodnoty v proměnné a change-string, která převede escape sekvence na string.<br>
Ve funkcích pro instrukce je dle potřeby zjištěn typ a hodnota argumentu, pokud se jedná o proměnnou, jsou tyto informace zjištěny pomocí výše popsaných funkcí, je provedena daná instrukce, a každá funkce vrací číslo následující instrukce.<br>
Při případných chybových stavech program končí s odpovídajícím návratovým kódem.</p>
<h2 class="code-line" data-line-start="12" data-line-end="13"><a id="een_testovacho_skriptu_12"></a>Řešení testovacího skriptu:</h2>
<p class="has-line-data" data-line-start="13" data-line-end="20">Program zkontroluje argumenty zadané při spuštění programu - a uloží si tyto hodnoty (např. zdrojový kód interpretu, informace o testování jen parseru, …).<br>
Následně proběhne vygenerování začátku html, a poté je podle parametrů spuštěn samotný program.<br>
Je otevřena složka a jsou z ní pomocí funkce open-dir načteny všechny elementy. Z těchto elementů jsou vybrány pouze zdrojové soubory (funkce src-files).<br>
Tyto soubory jsou jeden po druhém procházeny (ukládá se jejich počet). Pokud se jedná jen o interpret-only, proběhne pokus o otevření <em>.in</em> souboru - pokud neexistuje, vytvoří se prázdný soubor (následně je smazán). Následně je podle parametrů spuštěn interpret nebo parser nad vstupním souborem, a pomocí funkce check-return-val je zkontrolována návratová hodnota. Pokud soubor s návratovou hodnotou chybí, je návratová hodnota porovnávana s hodnotou 0. Pokud hodnota odpovídá očekávané hodnotě, je v případě nenulového návratového kódu zvýšen počet úspěšných testů a začíná kontrola dalšího souboru. Pokud hodnota neodpovídá, je vypsána příslušná hláška (do html), a pokračuje se kontrolou dalšího souboru. Pokud je návratový kód shodný s očekávaným, a je roven 0, je buď zkontrolován výstup (pokud se jedná o int-only či parse-only), nebo je výstup parseru předat interpretu. Interpret provede výše popsané v tomto odstavci, a následuje kontrola kódu.<br>
Kontrola kódu probíhá pomocí diff v případě výstupu z interpretu, a  pomocí speciálního nástroje v případě výstupu parseru. Pokud soubor s výstupem chybí, je vygenerován prázdný, který se následně odstraní. Pokud je výstup shodný, je navýšen počet úspěšných testů, a v případě úspěchu i neúspěchu je vypsána příslušná hláška (do html). Následuje kontrola následujícího souboru.<br>
Vnořené prohledávání adresářů (argument --recursive) je provedeno pomocí rekursivního volání hlavní funkce.<br>
Následně je dogenerováno html, je vypsán počet úspěšných testů z celkového počtu testů a úspěšnost v procentech.</p>
</div>
</div>
</div>
</div>
